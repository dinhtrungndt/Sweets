        ...
        <View style={styles.modalContent} onPress={() => setModalVisible(true)}>
          <TouchableOpacity style={styles.modalItem} onPress={handleUpLoad}>
            <Image
              ...
              source={require('../../../../../../media/image/upload_icon_modal.png')}
            />
          ...
          <TouchableOpacity style={styles.modalItem}>
            <Image
              style={[styles.modalIcon, {width: 20, height: 20}]}
              source={require('../../../../../../media/image/story_icon_modal.png')}
            />
          ...
          <TouchableOpacity style={styles.modalItem}>
            <Image
              style={[styles.modalIcon, {width: 20, height: 20}]}
              source={require('../../../../../../media/image/video_icon_modal.png')}
            />
          ...
          <TouchableOpacity style={styles.modalItem}>
            <Image
              ...
              source={require('../../../../../../media/image/live_icon.modal.png')}
            />
