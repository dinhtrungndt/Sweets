    ...
    <View>
      ...
      <View style={styles.bodyAccount}>
        ...
        <TouchableOpacity style={styles.userFrame}>
          ...
          <Image style={styles.imgNext} source={require('../../../../assets/icon_next.png')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.emailFrame}>
          <Image style={styles.imgEmail} source={require('../../../../assets/account_bottomTab.png')} />
          <Text style={styles.txtEmail}>Email</Text>
          <Text style={styles.txtEmail2}>{user.user.email}</Text>
          <Image style={styles.imgNext2} source={require('../../../../assets/icon_next.png')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.qrFrame}>
          <Image style={styles.imgEmail} source={require('../../../../assets/qr-scan2.png')} />
      ...
      <View style={styles.bodySecurity}>
        ...
        <TouchableOpacity style={styles.qrFrame}>
          <Image style={styles.imgEmail} source={require('../../../../assets/icon_lock.png')} />
