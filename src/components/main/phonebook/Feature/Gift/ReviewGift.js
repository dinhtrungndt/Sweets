...
const ReviewGift = () => {
    ...
    const { selectedItem, wishText, selectedImage, avatar, name } = route.params;
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
            <View style={styles.wrapInfo}>
                ...
                <Text style={styles.txtname}>Xem trước thiệp</Text>
            </View>

            <View style={{ margin: 15, alignItems: 'center', borderWidth: 1, borderColor: 'lightgray', borderRadius: 20 }}>
                <Image source={selectedImage} style={{ width: '100%', height: '60%', resizeMode: 'contain',borderBottomLeftRadius:40,borderBottomRightRadius:40 }} />
